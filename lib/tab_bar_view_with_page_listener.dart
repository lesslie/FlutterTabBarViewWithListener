...
class TabBarViewWithPageListener extends StatefulWidget {

  final ValueChanged<int> onPageChanged;
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const TabBarViewWithPageListener({
    Key key,
...
class _TabBarViewState extends State<TabBarViewWithPageListener> {
  ...
  @override
  void didUpdateWidget(TabBarViewWithPageListener oldWidget) {
